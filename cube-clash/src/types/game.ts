...
export interface PlayerStats {
  ...
  stability: number;
  // EFFECT FLAGS
  canAbsorbProjectiles?: boolean;
  vinesRegen?: boolean;
  lowHealthBerserk?: boolean;
  stationaryShield?: boolean;
}
...
export type GamePhase = 'menu' | 'tutorial' | 'playerSelect' | 'multiplayer' | 'archetypeSelect' | 'customization' | 'levelVote' | 'playing' | 'drafting' | 'gameover' | 'shop' | 'matchOver';
