  ...
  return (
    <div id="game-container" className="fixed inset-0 bg-[#05070a] z-0">
      ...
      {controlMode === 'pc' ? (
        ...
        <div className="absolute inset-0 pointer-events-none flex items-end justify-between p-8 md:p-16 z-50">
          <div className="flex gap-4 pointer-events-auto">
            <button
               ...
               className="w-20 h-20 bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl flex items-center justify-center active:bg-white/20 active:scale-95 transition-all text-white/40 active:text-white"
            >
               <ChevronLeft size={40} />
            </button>
            <button
          ...
          <div className="flex gap-4 pointer-events-auto">
            <button
               ...
               className="w-24 h-24 bg-white/10 backdrop-blur-md border border-white/10 rounded-full flex items-center justify-center active:bg-white/20 active:scale-95 transition-all text-white/40 active:text-white"
            >
               <ChevronUp size={48} />
            </button>
            <button
               ...
               className="w-24 h-24 bg-white/20 backdrop-blur-md border border-white/20 rounded-full flex items-center justify-center active:bg-white/40 active:scale-95 transition-all text-cyan-400 active:text-cyan-300"
            >
